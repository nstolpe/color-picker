...
const SaturationValueCanvas = ({
  ...
  const handlePointerMove = (event) => {
    ...
    if (isDragging) {
      updateColorFromCanvasCoordinates({
        x: clamp(x, 0, width - 1),
    ...
    (cnvs) => {
      if (cnvs && width > 0 && height > 0) {
        ...
        rowGradient.addColorStop(
          0,
          `rgba(${255 - rowFirst[0]},${255 - rowFirst[1]},${
            255 - rowFirst[2]
          },1)`
        );
        rowGradient.addColorStop(
          1,
          `rgba(${255 - rowLast[0]},${255 - rowLast[1]},${255 - rowLast[2]},1)`
        );
        colGradient.addColorStop(
          0,
          `rgba(${255 - colFirst[0]},${255 - colFirst[1]},${
            255 - colFirst[2]
          },1)`
        );
        colGradient.addColorStop(
          1,
          `rgba(${255 - colLast[0]},${255 - colLast[1]},${255 - colLast[2]},1)`
        );
